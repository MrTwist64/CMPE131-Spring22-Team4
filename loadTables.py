...
userTest = User(uID=0, first_name='Testy', last_name='Test', username='testyTest', email='testy@gmail.com', password_hash='randomHash')  

userTest2 = User(uID=1, first_name='Taeyong', last_name='Lee', username='ty_xoxo', email='lty1995@neotech.com', password_hash='randomHash2')
userTest3 = User(uID=2, first_name='Johnny', last_name='Suh', username='johnnysuhlee', email='jjsuh@neotech.com', password_hash='randomHash3')
userTest4 = User(uID=3, first_name='Yuta', last_name='Nakamoto', username='tako_ya', email='naYu06@neotech.com', password_hash='randomHash4')
userTest5 = User(uID=4, first_name='Mark', last_name='Lee', username='onyour__mark', email='mmarkly99@neotech.com', password_hash='randomHash5')
userTest6 = User(uID=5, first_name='Sungchan', last_name='Jung', username='jschannie27', email='singsangsung_chan@neotech.com', password_hash='randomHash6')
userTest7 = User(uID=6, first_name='Doyoung', last_name='Kim', username='do0_ie', email='doyo982@neotech.com', password_hash='randomHash7')
userTest8 = User(uID=7, first_name='Yangyang', last_name='Liu', username='wooly_yang', email='blacksheep9023@neotech.com', password_hash='randomHash8')
userTest9 = User(uID=8, first_name='Kun', last_name='Qian', username='kuncloud1010', email='cloudy1011@neotech.com', password_hash='randomHash9')
userTest10 = User(uID=9, first_name='Oliver', last_name='Stuart', username='oliveStu389', email='oliver_stuart5843@info44.tech', password_hash='randomHash10')
userTest11 = User(uID=10, first_name='Roger', last_name='Hunt', username='rrrogerd', email='Roger_Hunt6249@gmal.com', password_hash='randomHash11')
userTest12 = User(uID=11, first_name='Gil', last_name='Brooks', username='gills17Fsh', email='Gil_Brooks5827@atink.com', password_hash='randomHash12')
userTest13 = User(uID=12, first_name='Holly', last_name='Poulton', username='mistletoad12', email='Holly_poulton532@nickia.com', password_hash='randomHash13')
userTest14 = User(uID=13, first_name='Alessia', last_name='Middleton', username='alleycaat0', email='alessia_Middleton1512@gmail.com', password_hash='randomHash14')
